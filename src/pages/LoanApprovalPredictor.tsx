...
const LoanApprovalPredictor: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="Loan Approval Predictor | BeamX Solutions"
        description="Use BeamX Solutions' Loan Approval Predictor to get faster, smarter, and more accurate automated lending decisions."
        path="/products/loan-approval-model"
      />
      {/* Hero Section */}
